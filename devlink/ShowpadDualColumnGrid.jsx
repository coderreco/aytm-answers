...
import _styles from "./ShowpadDualColumnGrid.module.css";
...
export function ShowpadDualColumnGrid({
  as: _Component = _Builtin.Block,
  tileImageLeft = "https://cdn.prod.website-files.com/62c5cd2a77ff1625c04bcfcd/64092acba5623b3e3cc8c7f0_showpad-img-b.webp",
  tileImageRight = "https://cdn.prod.website-files.com/62c5cd2a77ff1625c04bcfcd/64092a174109b234f8a23100_showpad-img-a%20(1).webp",
  tileHeaderLeft = "Your research, done faster",
  tileHeaderRight = "Become more agile",
  dualColumnParagraphLeft = "Every great journey starts with a good map. Not only can the right map reveal a destination, it can help you plan the best path forward. If you’re looking to begin your voyage into the world of agile insights but unsure how to get underway, this is where to start.",
  dualColumnParagraphRight = "Maybe you're already in the process of championing the iterative approach to research. But no one wants to go it alone, right? This step-by-step guide to evaluating partners, platforms, and vendors provides a checklist to find the right tools and partners for agile transformation.",
  leftButtonText = "Learn More",

  leftButtonLinkAttachment = {
    href: "#",
    target: "_blank",
  },

  rightButtonLinkAttachment = {
    href: "#",
    target: "_blank",
  },

  rightButtonText = "View The Sheet",
  dualColumnLayoutVisibility = true,
}) {
  _interactions.useInteractions(_interactionsData, _styles);

  return dualColumnLayoutVisibility ? (
    <_Component
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <_Builtin.Image
                    className={_utils.cx(_styles, "showpad-tile-image")}
                    loading="lazy"
                    width="auto"
                    height="auto"
                    alt=""
                ...
                >
                  ...
                  >
                    <_Builtin.Paragraph>
                      {dualColumnParagraphLeft}
                    </_Builtin.Paragraph>
                  </_Builtin.Block>
                </_Builtin.Block>
                <_Builtin.Block
                  className={_utils.cx(_styles, "margin-top")}
                  tag="div"
                >
                  <_Builtin.Block
                    className={_utils.cx(
                  ...
                  >
                    ...
                    >
                      <_Builtin.Link
                        ...
                        button={true}
                        block=""
                        options={leftButtonLinkAttachment}
                      >
                        {leftButtonText}
                      </_Builtin.Link>
                    </_Builtin.Block>
                  ...
                  >
                    ...
                    >
                      <_Builtin.Link
                        ...
                        button={true}
                        block=""
                        options={rightButtonLinkAttachment}
                      >
                        {rightButtonText}
                      </_Builtin.Link>
                    </_Builtin.Block>
