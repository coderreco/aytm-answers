...
import _styles from "./ResourceHubHero.module.css";
...
export function ResourceHubHero({
  ...
  backgroundImage = "https://cdn.prod.website-files.com/62c5cd2a77ff1625c04bcfcd/65cfffe1aa1a609953c3920f_Resources%20bg.webp",
  heading = "Articles",
  subheading = "The latest news from aytm",
}) {
        ...
        <_Builtin.Block tag="div">
          ...
          >
            ...
            >
              ...
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "resources-nav-wrapper")}
                  tag="div"
                >
                  <ResourcesNavbar />
                </_Builtin.Block>
