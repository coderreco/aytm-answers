...
import _styles from "./HeaderPhotoWhiteNoButtons.module.css";
...
export function HeaderPhotoWhiteNoButtons({
  as: _Component = _Builtin.Block,
  mainHeading = "Empower your curiosity",
  secondaryHeadingText = "and truly own your insights",
  backgroundImage = "",
}) {
