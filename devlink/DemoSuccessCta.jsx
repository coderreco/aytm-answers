...
import _styles from "./DemoSuccessCta.module.css";
...
export function DemoSuccessCta({
  as: _Component = _Builtin.Block,
  heading = "Just can't wait? Here are a few things you can start with right now",

  link1Link = {
    href: "https://aytm.com/users/new",
    target: "_blank",
  },
  ...
  link3Link = {
    href: "https://insights.aytm.com/guide-to-better-survey-design",
    target: "_blank",
  },

  link1Text = "Register for a free account",
  link2Text = "Discover pathways for research success",
  link3Text = "Read the guide to better survey design",
  backgroundImage = "https://cdn.prod.website-files.com/62c5cd2a77ff1625c04bcfcd/65f1de3dec13d2027b09f8d5_cta-primary-bg.avif",
}) {
    ...
    <_Component className={_utils.cx(_styles, "section")} tag="div">
      <_Builtin.Block className={_utils.cx(_styles, "page-padding")} tag="div">
        ...
        >
          ...
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "grid-element", "demo")}
              tag="div"
            >
              <_Builtin.Block
                ...
                id={_utils.cx(
                  _styles,
                  "w-node-d51fdfdb-8b21-c793-c16b-4495262c12f2-262c12ed"
                )}
                tag="div"
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "demo-text-wrapper")}
                  tag="div"
                >
                  <_Builtin.Block
                    className={_utils.cx(
              ...
              <_Builtin.Block
                className={_utils.cx(_styles, "demo-success_navlink-container")}
                id={_utils.cx(
                  _styles,
                  "w-node-d51fdfdb-8b21-c793-c16b-4495262c12f7-262c12ed"
                )}
                tag="div"
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "demo-success_navlink-wrapper")}
                  tag="div"
                >
                  <_Builtin.Link
                    className={_utils.cx(_styles, "demo-success_navlink")}
                    id={_utils.cx(
                      _styles,
                      "w-node-d51fdfdb-8b21-c793-c16b-4495262c12f9-262c12ed"
                    )}
                    button={false}
                    block="inline"
                    options={link1Link}
                  >
                    <_Builtin.Block tag="div">{link1Text}</_Builtin.Block>
                    <_Builtin.Image
                      className={_utils.cx(
                        _styles,
                        "link-arrow",
                      ...
                      height="auto"
                      alt=""
                      src="https://cdn.prod.website-files.com/62c5cd2a77ff1625c04bcfcd/65f3504e3d85c7ad566b1249_right-arrow-blue.svg"
                    />
                  </_Builtin.Link>
                  <_Builtin.Link
                    className={_utils.cx(_styles, "demo-success_navlink")}
                    ...
                    options={link2Link}
                  >
                    <_Builtin.Block tag="div">{link2Text}</_Builtin.Block>
                    <_Builtin.Image
                      className={_utils.cx(
                        _styles,
                        "link-arrow",
                  ...
                  <_Builtin.Link
                    ...
                    options={link3Link}
                  >
                    <_Builtin.Block tag="div">{link3Text}</_Builtin.Block>
                    <_Builtin.Image
                      className={_utils.cx(
                        _styles,
                        "link-arrow",
              ...
              <_Builtin.Block
                ...
                id={_utils.cx(
                  _styles,
                  "w-node-d51fdfdb-8b21-c793-c16b-4495262c1305-262c12ed"
                )}
                tag="div"
              >
                <_Builtin.Image
