...
import _styles from "./HeaderPhotoWithButtons.module.css";
...
export function HeaderPhotoWithButtons({
  as: _Component = _Builtin.Block,
  heading = "Heading Text",
  subheading = "Subheading Text",
  backgroundImage = "",
  mainButtonText = "Button Left",

  mainButtonLink = {
    href: "#",
  },

  secondaryButtonText = "Button Right",
